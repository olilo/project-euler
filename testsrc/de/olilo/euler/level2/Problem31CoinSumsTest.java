...
public class Problem31CoinSumsTest {
    ...
    public void testGetPossibleSolutionsFor11() throws Exception {
        ...
        final List<Problem31CoinSums.Coins> expected = new ArrayList<>();
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 0, 0, 11));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 0, 1, 9));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 0, 2, 7));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 0, 3, 5));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 0, 4, 3));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 0, 5, 1));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 1, 0, 6));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 1, 1, 4));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 1, 2, 2));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 1, 3, 0));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 0, 2, 0, 1));
        expected.add(new Problem31CoinSums.Coins(0, 0, 0, 0, 1, 0, 0, 1));
        final List<Problem31CoinSums.Coins> actual = new Problem31CoinSums().getPossibleSolutionsFor(11);
        Assert.assertEquals(expected, actual);
    }
